...
class Bubble extends StatelessWidget {
  Bubble({
    ...
    BubbleStyle style,
        ...
        me = style.me ? true : false,
        urlcircle =
            style.me ? mainuser.avtarUrl : 'assets/zebo_illustration.png',
  ...
  Widget build(context) {
    ...
    return Container(
        ...
        child: me
            ? Container(
                padding: EdgeInsets.only(left: globals.w*0.385254645),
                child: Row(
                  children: <Widget>[
                    PhysicalShape(
                      ...
                      child: Container(
                        width: globals.w*0.4,
                          padding: bubbleClipper.edgeInsets, child: child),
                      color: color,
                      elevation: elevation,
                    ...
                    Container(
                      child: CircleAvatar(
                        radius: globals.w * 0.0277777777 * 2,
                        child: Container(
                            width: globals.w * 0.0277777777 * 4,
                            height: globals.w * 0.0277777777 * 4,
                            decoration: new BoxDecoration(
                                shape: BoxShape.circle,
                                image: new DecorationImage(
                                    fit: BoxFit.fill,
                                    image:
                                        new NetworkImage(mainuser.avtarUrl)))),
                      ),
                    ),
                  ],
                ),
            ...
            : Row(
                children: <Widget>[
                  CircleAvatar(
                    child: Image.asset('assets/zebo_illustrator.png'),
                    radius: globals.w*0.027777778*3.0,

...
class IntroSliderState extends State<IntroSlider>
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          Image.asset('assets/b.png', height: MediaQuery
              .of(context)
              .size
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                  image: AssetImage('assets/bottom_shape.png'),
                  fit: BoxFit.fill
              ),
            ),
          ),
          Container(
            padding: EdgeInsets.only(top: globals.h*0.0512820513),
            alignment: Alignment.topCenter,
            child: Image.asset('assets/avatar_round.png', scale: 1.8,),
          ),
  ...
  Widget renderTab( // Title
    ...
    Container(
    margin: EdgeInsets.only(top: globals.h*0.256410256, left: globals.w*0.083333333, right: globals.h*0.083333333),
    ...
    Container(
      margin: EdgeInsets.only(top: globals.h*0.13),
    color: Color.fromRGBO(237,250, 255, 1),
    height: globals.h*0.08,
    width: globals.w,
    child: Center(child: Text(title,style: TextStyle(color: Color.fromRGBO(12, 66, 88, 1),fontSize: globals.w*0.1),)
    ,
    )
    ,
    ),
